...
class PokemonForm extends React.Component {
  constructor(props) {
    super(props); //gives us access to React.Component parent that we extend from
    this.state = {
      pokeName: '',
    }
...
class App extends React.Component {
  ...
  componentDidUpdate() {
    console.log(this.state, 'STATE INSIDE COMPONENT DID UPDATE')
  }

  componentDidMount() {
    console.log(this.state, 'STATE INSIDE COMPONENT DID MOUNT')
